...
**18 images** : 4 établissements · 6 obligatoires · 8 rencontres. Deux variantes par image, le pipeline double le suffixe (`_a` → `_a_b`). Format `nom=prompt` pour `/leo-import`.
