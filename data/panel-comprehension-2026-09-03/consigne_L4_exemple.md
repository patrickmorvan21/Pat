...
TON PROFIL : tu es un NÉOPHYTE TOTAL : tu ne joues jamais aux jeux vidéo, tu ne lis pas de fantasy, on t'a mis ça dans les mains. Rien n'est évident pour toi (un dé, une stat, un « jet », une « run »). Dis ce que tu comprends avec ce bagage-là.
Ton transcript : /tmp/panel3/paquet/transcripts/v1.129.0-premiere-run-pressee.md
Ta table : /tmp/panel3/table4 — ton rapport : /tmp/panel3/rapports/L4.md
